...
function enviarNombre(nombre){
    ...
    $.ajax({
        url: "http://localhost:4000/authentication/buscar-por-socio",
        type: "POST",
...
function enviarAportaciones(nombre){
  ...
  $.ajax({
      url: "http://localhost:4000/authentication/buscador-aportaciones",
      type: "POST",
      data: JSON.stringify(json),
      contentType: "application/json; charset=UTF-8",
      headers: {
