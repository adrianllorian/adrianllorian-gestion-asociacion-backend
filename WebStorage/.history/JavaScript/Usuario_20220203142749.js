...
function verUsuario() { //Private
  $('button[id^="verUsuario"]').click(function () {
    ...
    $.ajax({
      url: "https://localhost:4000/authentication/ver-socio",
      type: "POST",
...
function mostrarAportacionPorUsuario() {
  $.ajax({
    url: "https://localhost:4000/authentication/verAportacion",
    type: "POST",
    data: JSON.stringify(IdUsuarioParaVer),
    contentType: "application/json; charset=UTF-8",
    headers: {
...
function descargarFoto(){
  $.ajax({
    url: "https://localhost:4000/authentication/extraerFotosUsuario",
    type: "POST",
    data: JSON.stringify(IdUsuarioParaVer),
    contentType: "application/json; charset=UTF-8",
    headers: {
...
function botonesModelBorrar() {
  ...
  $('#confirmarBorrarUsuario').click(function () {
    ...
    $.ajax({
      url: "https://localhost:4000/authentication/borrar-socio",
      type: "POST",
...
function enviarUsuarioEditar(json) {
  $.ajax({
    url: "https://localhost:4000/authentication/guardar-socio",
    type: "POST",
    data: JSON.stringify(json),
    contentType: "application/json; charset=UTF-8",
    headers: {
...
function preparaFormulario() {  
  ...
  function enviarUsuario(json){
    ...
    $.ajax({
        url: "https://localhost:4000/authentication/guardar-usuario-con-foto",
        type: "POST",
        data: dataForm,
        contentType:false,
        processData: false,
